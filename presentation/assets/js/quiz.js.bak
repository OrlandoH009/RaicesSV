...
// 100% GUANACO (15)
  { cat: 'leyendas', nivel: 'guanaco', pregunta: '¿Qué relación mitológica existe entre el dios Teotl y la maldición de Sihuehuet en la tradición nahua-pipil?', opciones: ['Teotl la condenó a la vagancia eterna y le arrebató a su hijo tras su traición', 'Fue bendecida con la juventud eterna', 'Fue transformada en serpiente emplumada', 'Se convirtió en la diosa tutelar de los ríos'], correcta: 0, explicacion: 'Teotl condenó a Sihuehuet a vagar eternamente como la Siguanaba y le arrebató a su hijo, condenándolo a no crecer jamás.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: 'En la obra literaria de Miguel Ángel Espino y el folclore popular, ¿cómo se describe la presencia del Cipitío en las moliendas?', opciones: ['Como un duende juguetón que come cenizas y la espuma del dulce de atado', 'Como un espectro sangriento que destruye los trapiches', 'Como un gigante sabio de las montañas', 'Como un espíritu maligno que roba el ganado'], correcta: 0, explicacion: 'El Cipitío es retratado como un ser inofensivo y juguetón atraído por el dulce de atado, las moliendas y las cenizas de los hornos.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: '¿Qué criatura mítica del folclore de Sonsonate e Izalco es mitad serpiente y mitad cerdo, anunciadora de lluvias y temblores?', opciones: ['La Cuyancúa', 'La Chancha Bruja', 'El Mico Brujo', 'El Cadejo negro'], correcta: 0, explicacion: 'La Cuyancúa (o Cuyancuat) es un ser mitológico de la zona de Izalco asociado a las fuentes de agua, lluvias y sismos.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: '¿Cuál es el significado simbólico y ecológico de La Cuyancúa en la tradición oral de Izalco?', opciones: ['Proteger los nacimientos de agua y anunciar cambios climáticos o desbordamientos', 'Castigar a los cazadores furtivos', 'Proteger los cultivos de café', 'Guiar a los marineros en la costa'], correcta: 0, explicacion: 'En la tradición náhuat, la Cuyancúa es una deidad o espíritu guardián de los manantiales y quebradas.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: '¿Qué figura del folclore salvadoreño representa a una hechicera transformada en cerda para asustar noctámbulos?', opciones: ['La Chancha Bruja', 'La Siguanaba', 'La Llorona', 'La Ciguanaba de montaña'], correcta: 0, explicacion: 'La Chancha Bruja es la personificación de una mujer con artes de hechicería que toma forma de porcino a medianoche.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: 'En las leyendas del oriente salvadoreño, ¿qué es el "Mico Brujo"?', opciones: ['Una bruja o curandero transformado en simio mediante artes oscuras', 'Un espíritu protector de las ceibas', 'Un duende de las cavernas', 'Un animal sagrado azteca'], correcta: 0, explicacion: 'El Mico Brujo es una transformación mediante nahualismo o brujería para hacer travesuras y sobresaltar a los vecinos.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: '¿Qué leyenda salvadoreña relata la historia de un ente con cadenas pesadas que recorre los caminos rurales?', opciones: ['El Chucho Cadenero / El Cadejo', 'El Cipitío', 'El Justo Juez', 'El Duende de la cueva'], correcta: 0, explicacion: 'El Chucho Cadenero o Cadejo encadenado es una variante donde el arrastre de cadenas anuncia su escalofriante paso.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: 'En la tradición del "Justo Juez de la Noche", ¿cómo se manifiesta ante quienes andan fuera de hora?', opciones: ['Como un jinete de blanco sin rostro o con una luz fantasmal', 'Como un niño con sombrero de palma', 'Como un perro negro de ojos rojos', 'Como una anciana pidiendo limosna'], correcta: 0, explicacion: 'El Justo Juez de la Noche se aparece alto, impetuoso y a menudo sin cabeza o con rostro difuso impertérrito.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: '¿Cuál es la creencia mística sobre la Flor de Amate en El Salvador?', opciones: ['Brota a medianoche de un árbol sin flores y otorga suerte o deseos a quien la atrape', 'Nace en el fondo de los ríos al amanecer', 'Es una flor que solo ven las personas mudas', 'Solo florece durante los eclipses de luna'], correcta: 0, explicacion: 'La tradición dice que el árbol de amate florece a la medianoche con una flor blanca mágica que cae al suelo y debe ser atrapada con un pañuelo blanco.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: '¿Por qué se dice en el folclore que el Cadejo blanco y el Cadejo negro mantienen un combate eterno?', opciones: ['Porque representan el equilibrio dual entre la protección y la perdición', 'Porque son hermanos castigados por los dioses', 'Porque compiten por el amor de la Siguanaba', 'Porque desaparecen con el canto del gallo'], correcta: 0, explicacion: 'Representan la clásica dualidad mesoamericana e hispánica del bien (protección del caminante) frente al mal.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: '¿Qué ritual popular se atribuía a las brujas de pueblo para lograr la metamorfosis en animales (nahualismo)?', opciones: ['Dar tres volteretas hacia atrás y recitar oraciones al revés', 'Bañarse en agua de siete pozos', 'Quemar hojas de izote en un comal', 'Enterrar una moneda de plata'], correcta: 0, explicacion: 'El folclore oral afirmaba que dar volteretas en el suelo ("dar el brinco") permitía al hechicero cambiar su forma a animal.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: 'Según la tradición oral de Los Planes de Renderos, ¿qué figura mítica habita en las grietas de la Puerta del Diablo?', opciones: ['El Diablo o el Chivato encarcelado en las rocas', 'El Cadejo blanco', 'La Siguanaba', 'El Cipitío'], correcta: 0, explicacion: 'La leyenda de la Puerta del Diablo sostiene que el cerro fue partido por el Diablo al ser perseguido por los patronos celestiales.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: '¿Qué rasgo físico característico enciende los ojos del Cadejo negro en las narraciones del campo?', opciones: ['Brillan como brasas de carbón o fuego rojo en la penumbra', 'Son completamente blancos e invisibles', 'Cambian de color según la luna', 'Son como perlas cristalinas'], correcta: 0, explicacion: 'Los campesinos describen al Cadejo negro con ojos rojos incandescentes como brasas de fuego encendidas.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: 'En las versiones más macabras de la Carreta Chillonas o Bruja, ¿de qué se dice que están hechas sus piezas?', opciones: ['De huesos humanos y las ruedas chorrean sangre', 'De madera de amate bendita', 'De hierro traído de España', 'De caña de azúcar seca'], correcta: 0, explicacion: 'La versión terrorífica describe que el chasis y estacas son tibias y calaveras humanas, y sus ruedas chirrían sin cesar.' },
  { cat: 'leyendas', nivel: 'guanaco', pregunta: '¿Qué personaje folclórico salvadoreño es famoso por trenzar las crines de los caballos durante la noche?', opciones: ['El Duende', 'El Cipitío', 'El Cadejo', 'El Justo Juez'], correcta: 0, explicacion: 'En la tradición rural, al Duende se le atribuye hacer trenzas apretadas en las crines de los caballos y molestar a las jóvenes bonitas.' }
