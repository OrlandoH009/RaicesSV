    ...
    /* ══════════════════════════════════════════════════════════
       ...
       ══════════════════════════════════════════════════════════ */
    // 1. Inicializamos el mapa con tus coordenadas y zoom por defecto (respaldo si el usuario no da permiso)
...
if (navigator.geolocation) {
  ...
  mostrarToastGeo('Tu navegador no soporta geolocalización. Mostrando vista general de El Salvador.', 'error');
    ...
    /* ══════════════════════════════════════════════════════════
       ...
       ══════════════════════════════════════════════════════════
       Si el landmark trae "img" se usa esa URL; si no, se genera
       una imagen de relleno consistente (misma por id) mientras
       se agregan las fotos reales.
       ══════════════════════════════════════════════════════════ */
    ...
    /* ── Renderizar markers (info se muestra en la sidebar, sin popup) ── */
    const markers = [];
    ...
    LANDMARKS.forEach(lm => {
      ...
      /* ── Tooltip hover: nombre + imagen de referencia ── */
      marker.bindTooltip(
    ...
    /* ══════════════════════════════════════════════════════════
       ...
       (ej. Calendario) llegada vía ?from=calendario.html.
       El estado que se estaba navegando allí (filtros, vista,
       tarjeta abierta, scroll) lo restaura esa misma página
       leyendo su propio sessionStorage al cargar.
       ══════════════════════════════════════════════════════════ */
    (function configurarBotonVolver() {
      ...
      // Solo permitir rutas relativas propias del sitio (evita redirecciones externas)
    ...
    /* ══════════════════════════════════════════════════════════
       DESTACAR LANDMARK BUSCADO (llega desde "Ver en mapa" /
       "Explorar en Mapa Interactivo" del Calendario, vía ?evento=ID)
       ══════════════════════════════════════════════════════════ */
