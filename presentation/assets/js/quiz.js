...
const PREGUNTAS_EN = [
  ...
  // Hard (28)
  { cat: 'gastronomia', nivel: 'dificil', pregunta: "What traditional dessert of ayote (squash) cooked in panela syrup is prepared in El Salvador for the Day of the Dead (November 2)?", opciones: ["Ayote en miel", "Yuca nuégados", "Torrejas", "Rice pudding"], correcta: 0, explicacion: "Ayote en miel (squash cooked with panela and cinnamon) is a traditional sweet associated with the Day of the Dead in El Salvador." },
  ...
  { cat: 'gastronomia', nivel: 'guanaco', pregunta: "What shrimp-based dish is traditionally prepared during Lent and Holy Week in El Salvador, when red meat is avoided?", opciones: ["Shrimp ceviche with lime", "Shrimp patties in red sauce", "Garlic shrimp", "Shrimp and coconut soup"], correcta: 1, explicacion: "Torta de camarón (dried ground shrimp with egg, fried and bathed in tomato sauce) is a traditional Lent and Holy Week dish in El Salvador." },
  ...
  { cat: 'leyendas', nivel: 'facil', pregunta: "In what part of San Salvador is El Padre sin Cabeza said to appear?", opciones: ["At El Rosario Church", "At the Cuscatlán Park", "At the downtown Zócalo", "At the Ex-Cuartel Market"], correcta: 0, explicacion: "According to legend, El Padre sin Cabeza comes out through the doors of El Rosario Church on Fridays at midnight." },
