...
(function () {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      "jue.card6.diff.easyDesc": "Calle alegre y más silbadores",
      "jue.card6.diff.hardDesc": "Mayor velocidad y obstáculos",
    ...
    en: {
      ...
      "jue.card6.diff.easyDesc": "Cheerful street, more whistlers",
      "jue.card6.diff.hardDesc": "Higher speed and more obstacles",
      ...
      puntos: {
        ...
        74: { nombre: "Santa Tecla Patron Saint Festivities", lugar: "Santa Tecla, La Libertad", desc: "Santa Tecla's patron saint festivities honoring the Christ Child, with a fair, carnival, and cultural events from December 1 to 25.", chips: ["Patron Saint Festival", "Fair"] },
        75: { nombre: "Antiguo Cuscatlán Patron Saint Festivities", lugar: "Antiguo Cuscatlán, La Libertad", desc: "Antiguo Cuscatlán's patron saint festivities honoring the Holy Innocents, with carnival, fair, and food from December 26 to 28.", chips: ["Patron Saint Festival", "Carnival"] },
        76: { nombre: "Cojutepeque Patron Saint Festivities", lugar: "Cojutepeque, Cuscatlán", desc: "Cojutepeque's patron saint festivities honoring the Virgin of the Conception and Saint Sebastian, with the traditional crowning of the Sugarcane Queen.", chips: ["Patron Saint Festival", "Tradition"] },
        ...
        78: { nombre: "Ilopango Patron Saint Festivities", lugar: "Ilopango, San Salvador", desc: "Ilopango's patron saint festivities honoring Saint Christopher the Martyr, with parades, processions, and a queen's coronation.", chips: ["Patron Saint Festival", "Procession"] },
        79: { nombre: "Soyapango Patron Saint Festivities", lugar: "Soyapango, San Salvador", desc: "Soyapango's patron saint festivities honoring Our Lady of the Rosary, with a mail parade, trade fair, and food contests.", chips: ["Patron Saint Festival", "Fair"] },
        80: { nombre: "Suchitoto Patron Saint Festivities", lugar: "Suchitoto, Cuscatlán", desc: "Suchitoto's patron saint festivities honoring Saint Lucy, with a mail parade, floats, and fireworks.", chips: ["Patron Saint Festival", "Floats"] },
        81: { nombre: "Zacatecoluca Patron Saint Festivities", lugar: "Zacatecoluca, La Paz", desc: "Zacatecoluca's patron saint festivities honoring Our Lady of the Poor and Saint Paul the Apostle, with religious events and a fair.", chips: ["Patron Saint Festival", "Fair"] },
        82: { nombre: "Sensuntepeque Patron Saint Festivities", lugar: "Sensuntepeque, Cabañas", desc: "Sensuntepeque's patron saint festivities honoring Saint Barbara, with religious and cultural activities.", chips: ["Patron Saint Festival", "Tradition"] },
        83: { nombre: "Usulután Patron Saint Festivities", lugar: "Usulután, Usulután", desc: "Usulután's patron saint festivities honoring Saint Catherine of Alexandria, with fifteen days of celebrations.", chips: ["Patron Saint Festival", "Fair"] },
        ...
        85: { nombre: "San Vicente Patron Saint Festivities", lugar: "San Vicente, San Vicente", desc: "San Vicente's patron saint festivities honoring Saint Vincent Abbot and Martyr, with dawn celebrations and the election of indigenous queens.", chips: ["Patron Saint Festival", "Tradition"] },
        86: { nombre: "Ahuachapán Patron Saint Festivities", lugar: "Ahuachapán, Ahuachapán", desc: "Ahuachapán's patron saint festivities honoring the Sweet Name of Jesus, with the traditional Mail Parade.", chips: ["Patron Saint Festival", "Parade"] },
        ...
        88: { nombre: "Metapán Festivities", lugar: "Metapán, Santa Ana", desc: "International fair and rodeo in Metapán, with concerts and activities for the whole family.", chips: ["Fair", "Rodeo"] },
        89: { nombre: "San Miguel Patron Saint Festivities", lugar: "San Miguel, San Miguel", desc: "San Miguel's patron saint festivities honoring the Virgin of Peace, ahead of the traditional Migueleño Carnival.", chips: ["Patron Saint Festival", "Carnival"] },
        90: { nombre: "Chinameca Patron Saint Festivities", lugar: "Chinameca, San Miguel", desc: "Chinameca's patron saint festivities honoring the Divine Savior of the World.", chips: ["Patron Saint Festival", "Tradition"] },
        91: { nombre: "San Jorge Patron Saint Festivities", lugar: "San Jorge, San Miguel", desc: "San Jorge's patron saint festivities honoring its patron saint, with religious and popular events.", chips: ["Patron Saint Festival", "Tradition"] },
        92: { nombre: "Moncagua Patron Saint Festivities", lugar: "Moncagua, San Miguel", desc: "Moncagua's patron saint festivities honoring the Virgin of Candelaria.", chips: ["Patron Saint Festival", "Tradition"] },
        93: { nombre: "Chirilagua Patron Saint Festivities", lugar: "Chirilagua, San Miguel", desc: "Chirilagua's patron saint festivities honoring the Virgin of Guadalupe.", chips: ["Patron Saint Festival", "Tradition"] },
        94: { nombre: "Guatajiagua Patron Saint Festivities", lugar: "Guatajiagua, Morazán", desc: "Guatajiagua's patron saint festivities honoring Saint Sebastian the Martyr, a town known for its black clay pottery.", chips: ["Black Pottery", "Crafts"] },
        95: { nombre: "Perquín Patron Saint Festivities", lugar: "Perquín, Morazán", desc: "Perquín's patron saint festivities honoring Saint Sebastian the Martyr.", chips: ["Patron Saint Festival", "Tradition"] },
        96: { nombre: "Corinto Patron Saint Festivities", lugar: "Corinto, Morazán", desc: "Corinto's patron saint festivities honoring Saint Peter the Apostle.", chips: ["Patron Saint Festival", "Tradition"] },
        97: { nombre: "Cacaopera Patron Saint Festivities", lugar: "Cacaopera, Morazán", desc: "Cacaopera's patron saint festivities honoring Our Lady of the Transit, a town of Kakawira indigenous culture.", chips: ["Kakawira Culture", "Tradition"] },
        98: { nombre: "San Alejo Patron Saint Festivities", lugar: "San Alejo, La Unión", desc: "San Alejo's patron saint festivities honoring the Lord of Miracles.", chips: ["Patron Saint Festival", "Tradition"] },
        99: { nombre: "Conchagua Patron Saint Festivities", lugar: "Conchagua, La Unión", desc: "Conchagua's patron saint festivities honoring Saint James the Apostle.", chips: ["Patron Saint Festival", "Tradition"] },
        100: { nombre: "Intipucá Patron Saint Festivities", lugar: "Intipucá, La Unión", desc: "Intipucá's patron saint festivities honoring the Immaculate Conception.", chips: ["Patron Saint Festival", "Tradition"] },
      ...
      "ev.fiestasMetapanecas.title": "Metapán Festival",
      ...
      "ev.patronalesChinameca.title": "Chinameca Patron Saint Festival",
