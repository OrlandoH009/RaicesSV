...
(function () {
  ...
  const TRANSLATIONS = {
    es: {
      ...
      "jue.card5.intro": "Lanzá tu tirador (T) desde abajo del círculo arrastrando el mouse.<br>Sacá las canicas de la ronda para ganar puntos.<br>¡Más canicas fuera = más puntos!",
    ...
    en: {
      ...
      "jue.card5.intro": "Launch your shooter marble (T) from below the circle by dragging the mouse.<br>Knock the marbles out of the ring to score points.<br>The more marbles out, the more points!",
      ...
      "jue.card5.ruleScore": "Marble knocked out of the circle → +1 point",
      "jue.card5.ruleShoot": "Golden shooter (T): drag and release to shoot",
      "jue.card5.ruleRounds": "3 rounds with more marbles each time",
      "jue.card5.ruleShotsWarn": "Limited shots — make every throw count!",
